...
import { useGetSingleOfferedCourseQuery } from "../../../redux/features/student/studentCourseManagementApi";
import moment from "moment";

const { Content } = Layout;
const { Text } = Typography;

const StudentOfferedCourseDetails = () => {
    const { offeredCourseId } = useParams<{ offeredCourseId: string }>();
    const { data: offeredCourseData, isLoading, isError } = useGetSingleOfferedCourseQuery(offeredCourseId || "");
            ...
            <Content style={{ margin: "15px" }}>
                <Card>
                    <Tabs defaultActiveKey="1" type="line">
                        <Tabs.TabPane tab="Class Schedule" key="1">
                            <Row gutter={[16, 16]}>
                                <Col span={24}>
                                    <Card>
                                        <div
                        ...
                        {/* Instructor Tab */}
                        <Tabs.TabPane tab="Instructor Info" key="4">
...
export default StudentOfferedCourseDetails;